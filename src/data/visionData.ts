  ...
  kpis: [
    {
      ...
      weeklyProgress: [
        { week: 'Week 1', focus: 'Monorepo Setup', status: 'in-progress', leadTasks: ['Local regression testing', 'Basic flows (login, dashboard)'], achievements: ['App runs via monorepo (pnpm dev)', 'Zero runtime errors introduced', 'No code refactor done'] },
        { week: 'Week 2', focus: 'Deployment Validation (Hard Gate)', status: 'upcoming', leadTasks: ['Production smoke test (/api/health)', 'Tenant-level validation'], achievements: ['CI pipeline success rate = 100%', 'Deployment works without errors', 'No UI/API behavior change'] },
    ...
    },
    {
      ...
      weeklyProgress: [
        { week: 'Week 1', focus: 'Foundation Setup', status: 'upcoming', leadTasks: ['Setup design-tokens, ui-web, ui-mobile', 'Configure shadcn + NativeWind + Gluestack', 'Define design tokens'], achievements: ['Packages created & consumed', 'Tokens available in both', 'No UI outside shared'] },
        { week: 'Week 2', focus: 'Theme System', status: 'upcoming', leadTasks: ['Implement ThemeProvider (web)', 'Implement theme injection (mobile)', 'Connect tenant config → tokens'], achievements: ['2 tenants working with different themes', 'Theme changes reflect instantly', '0 hardcoded colors'] },
        { week: 'Week 3', focus: 'Build ALL Level 1 Components', status: 'upcoming', leadTasks: ['Button, Input, Textarea, Label', 'Select, Checkbox, Radio, Switch, DatePicker', 'Card, Modal, Drawer, Spinner, Toast'], achievements: ['100% Level 1 components built', 'Same API across platforms', 'All states supported', 'Theme-compliant'] },
        { week: 'Week 4', focus: 'Adopt Level 1 Components', status: 'upcoming', leadTasks: ['Replace base components in apps', 'Use Level 1 in real screens'], achievements: ['≥50% screens using L1', '5 key screens migrated/platform', 'No new base components created', 'Duplicate components removed'] },
        { week: 'Week 5', focus: 'Build Level 2 (Forms + Data)', status: 'upcoming', leadTasks: ['FormField, FormSection, ErrorMessage', 'AsyncSelect, FieldWrapper', 'DataTable, ListCard'], achievements: ['Core form abstraction ready', 'Data components support states', 'APIs consistent across platforms'] },
        { week: 'Week 6', focus: 'Build Level 2 (Nav + Structure)', status: 'upcoming', leadTasks: ['Tabs, Accordion', 'Pagination, EmptyState', 'SectionHeader, PageHeader'], achievements: ['Full L2 library complete', 'Works with feature flags', 'Components tested in isolation'] },
        { week: 'Week 7', focus: 'Adopt Level 2 Components', status: 'upcoming', leadTasks: ['Refactor forms and data screens', 'Replace implementations with shared components'], achievements: ['≥70% forms use FormField', '≥60% data views use shared', '5 screens migrated per app', 'Reduction in duplicate logic'] },
        { week: 'Week 8', focus: 'Build Level 3 (Batch 1)', status: 'upcoming', leadTasks: ['OTPInput', 'AddressForm', 'ProfileSection'], achievements: ['3–4 reusable business components', 'No tenant-specific logic', 'Used in at least 1 app'] },
        { week: 'Week 9', focus: 'Build Level 3 (Batch 2)', status: 'upcoming', leadTasks: ['KYCSection', 'InvestmentCard', 'Identify high-reuse components'], achievements: ['5–8 Level 3 components built', 'Standardized APIs', 'Ready for cross-app reuse'] },
    ...
    },
    {
      ...
      weeklyProgress: [
        { week: 'Week 1', focus: 'Zero Downtime Deployment', status: 'in-progress', leadTasks: ['Rolling deployment (Traefik+Docker)', 'Add /api/health endpoint', 'Enable rollback mechanism'], achievements: ['Zero failed requests during rollout', 'New container healthy before old stopped', 'Rollback executed within 10 mins'] },
        { week: 'Week 2', focus: 'Log Coverage & Visibility', status: 'upcoming', leadTasks: ['Structured API logging', 'Tenant-aware logs', 'Initial dashboards'], achievements: ['100% critical APIs emit structured logs', 'Logs visible for at least 2 tenants', 'Kibana dashboards show API latency/errors'] },
    ...
    },
    {
      ...
      weeklyProgress: [
        { week: 'Week 1', focus: 'Ownership Setup', status: 'upcoming', leadTasks: ['Assign Mobile & Web Owner', 'Define responsibilities clearly', 'Align deployment flow (QA→UAT→PROD)'], achievements: ['Ownership clarity: 100%', 'Deployment flow documented'] },
        { week: 'Week 2', focus: 'Autonomy Kickoff', status: 'upcoming', leadTasks: ['Devs propose solutions first', 'Lead avoids direct answers', 'Assign deployment ownership'], achievements: ['% tasks with dev-proposed approach ≥ 60%', 'Deployment ownership clarity: 100%'] },
