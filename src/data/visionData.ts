...
export const kpiData = {
  ...
  kpis: [
    ...
    },
    {
      ...
      weeklyProgress: [
        { week: 'Week 1', focus: 'Foundation Setup', status: 'completed', leadTasks: ['Setup design-tokens, ui-web, ui-mobile', 'Configure shadcn + NativeWind + Gluestack', 'Define design tokens'], achievements: ['Packages created & consumed', 'Tokens available in both', 'No UI outside shared'] },
        { week: 'Week 2', focus: 'Theme System', status: 'in-progress', leadTasks: ['Implement ThemeProvider (web)', 'Implement theme injection (mobile)', 'Connect tenant config → tokens'], achievements: ['2 tenants working with different themes', 'Theme changes reflect instantly', '0 hardcoded colors'] },
